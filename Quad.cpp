...
Quad::Quad():
	pVertexBuffer_(nullptr), pIndexBuffer_(nullptr),pConstantBuffer_(nullptr), pTexture_(nullptr), vertexNum_(0), indexNum_(0)
{
}
...
{
	//インデックス情報
	index_ = {0,2,3, 0,1,2}; //2,3,0でも3,0,2でも時計回りならいい
